        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-card border border-border rounded-lg p-6">
            ...
            <p className="text-2xl font-bold text-foreground">
              {contractState?.protocolTVL} <small>tDUST</small>
            </p>
          </div>
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            ...
            <p className="text-2xl font-bold text-foreground">
              {contractState?.total_stAsset_Minted} <small>sttDUST</small>
            </p>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-2 text-muted-foreground">
                ...
                <p className="text-sm">Super Admins and admins can create new pools</p>
              </div>
              <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div>
                  ...
                  <p className="text-lg font-semibold text-foreground">
                    tDUST{contractState?.protocolTVL}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground mb-1">
                  ...
                  <p className="text-lg font-semibold text-foreground">
                    sttDUST {contractState?.total_stAsset_Minted}
                  </p>
                </div>
              </div>
        ...
        {activeTab === "admins" && (
          <div>
            ...
            <div className="space-y-3">
              ...
              {contractState?.admins.map((admin) => (
                <div
                  key={admin}
