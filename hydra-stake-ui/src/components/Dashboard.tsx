...
const Dashboard = () => {
  const { hasConnected, contractState, privateState, isLoadingState } =
        ...
        <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="glass glass-hover rounded-2xl p-6 border border-purple-500/30 bg-linear-to-br from-purple-500/5 to-transparent">
                  ...
                  {isLoadingState ? (
                    ...
                    <p className="text-3xl font-bold text-white mb-1">
                      {privateState?.stAssets_minted} sttDUST
                    </p>
                  )}
                </div>
          ...
          <div className="glass rounded-3xl p-8 border border-indigo-500/20 bg-linear-to-br from-indigo-950/40 via-slate-950/20 to-transparent">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="glass glass-hover rounded-2xl p-6 border border-orange-500/30 bg-linear-to-br from-orange-500/5 to-transparent">
                <div className="flex items-center gap-3 mb-2">
                ...
                {isLoadingState ? (
                  <div className="h-9 w-20 bg-orange-500/10 animate-pulse rounded" />
                ) : (
                  <>
                    <p className="text-3xl font-bold text-white mb-1">
                      {contractState?.total_stake_withdrawn ?? 0}
                    </p>
                    <p className="text-sm text-orange-400">tDUST</p>
                  </>
                )}
              </div>
